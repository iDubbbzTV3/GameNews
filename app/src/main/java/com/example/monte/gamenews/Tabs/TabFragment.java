...
public class TabFragment extends Fragment {
    ...
    private com.example.monte.gamenews.ViewPagerAdapter adapter;
    public TabFragment() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag (new InformacionTab(), "Informacion");
        adapter.addFrag (new JugadoresTab(), "Jugadores");
        adapter.addFrag (new NoticiasTab(), "Noticias");
